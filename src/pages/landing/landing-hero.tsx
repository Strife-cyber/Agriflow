    ...
    <section className="relative min-h-screen flex items-center bg-gradient-to-br from-gray-900 via-slate-900 to-emerald-900 py-20 overflow-hidden isolate">
      ...
      <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8" data-aos={aos.fadeRight} data-aos-delay="100">
          <h1 className="text-2xl md:text-5xl font-bold leading-tight bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 via-teal-400 to-cyan-400 animate-text">
            {translation("heroHeading")}
          </h1>

          <p className="text-xl md:text-2xl text-gray-300/90 max-w-2xl leading-relaxed">
        ...
        <div className="relative" data-aos={aos.zoomIn} data-aos-delay="200">
          <Card className="shadow-2xl rounded-3xl border border-emerald-500/20 bg-slate-800/30 backdrop-blur-xl group transition-all duration-500 hover:-translate-y-2 hover:shadow-emerald-500/20">
            <CardContent className="p-0 relative overflow-hidden">
              ...
              {/* Holographic Overlay */}
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/70 via-transparent to-transparent flex items-end p-8 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
      ...
      <div
        ...
        data-aos-delay="500"
      >
        <div className="w-10 h-16 rounded-2xl border-2 border-emerald-400/30 relative backdrop-blur-sm bg-slate-900/30">
