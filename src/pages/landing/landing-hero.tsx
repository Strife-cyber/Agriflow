...
const LandingHero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center py-20 overflow-hidden isolate">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8" data-aos={aos.fadeRight} data-aos-delay="100">
          <h1 className="text-2xl md:text-5xl font-bold leading-tight bg-clip-text text-transparent bg-gradient-to-r from-emerald-600 via-teal-500 to-sky-400 animate-text">
          ...
          <Button
            size="lg"
            className="relative overflow-hidden bg-gradient-to-r from-emerald-500 to-sky-500 hover:to-sky-400 text-white rounded-xl px-10 py-7 text-lg font-semibold transition-all duration-300 group shadow-2xl hover:shadow-emerald-400/30"
          >
            <span className="relative z-10" onClick={() => navigate("/auth")}>
              {translation("continue")}
            </span>
            <div className="absolute inset-0 bg-gradient-to-r from-emerald-300/20 to-sky-300/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            ...
            <CardContent className="p-0 relative overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-white/70 via-transparent to-transparent flex items-end p-8 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <div className="space-y-4">
                  ...
                  <div className="h-1 bg-gradient-to-r from-emerald-400 to-sky-400 w-24 rounded-full" />
                </div>
              </div>

              {/* Shine Effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 -rotate-12 -translate-x-full group-hover:translate-x-full" />
            </CardContent>
          </Card>

          {/* Floating Badge */}
          <div
            className="absolute -top-2 -right-6 bg-gradient-to-br from-emerald-500 to-sky-500 text-white px-6 py-3 rounded-2xl shadow-2xl"
      ...
      <div
        ...
        data-aos-delay="500"
      >
        <div className="w-10 h-16 rounded-2xl border-2 border-emerald-400/60 relative backdrop-blur-sm bg-white/40">
          <div className="w-2 h-4 bg-gradient-to-b from-emerald-400 to-sky-400 rounded-full absolute top-3 left-1/2 -translate-x-1/2 animate-bounce-slow" />
        </div>
      </div>
    </section>
  );
