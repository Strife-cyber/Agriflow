...
const LandingHeader = () => {
  ...
  return (
    <header
      ...
      } transition-colors duration-300 py-4 px-6 md:px-12 shadow-md border-b border-emerald-500/30 fixed w-full top-0 z-50`}
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        {/* Logo */}
        <div data-aos={aos.fadeRight} className="flex items-center gap-2 group">
        ...
        <div className="flex items-center gap-4">
          <div data-aos={aos.zoomIn} data-aos-delay="400">
            <Button
            ...
            >
              <span className="relative z-10">
                {authState.connected ? translation("dashboard") : translation("login")}
              </span>
          ...
          <div data-aos={aos.zoomIn} data-aos-delay="500">
