// import { DataTypes, Model, Sequelize, ModelStatic, ModelAttributes, InitOptions } from "sequelize";
import { DataTypes, Model } from "sequelize";

/*
class Reading extends Model {
    static baseInit(attributes: ModelAttributes, options: Omit<InitOptions, 'sequelize'>, sequelize: Sequelize) {
        const readingModel: ModelStatic<Reading> = this; // This ensures that `this` refers to the actual model
...
class LightReading extends Reading {
    static baseInit(attributes: ModelAttributes, options: Omit<InitOptions, "sequelize">, sequelize: Sequelize): ModelStatic<Reading> {
...
let models: Record<string, ModelStatic<Model>> = {
    LightReading,
    TemperatureReading,
    Co2LevelReading,
    SoilHumidityReading,
